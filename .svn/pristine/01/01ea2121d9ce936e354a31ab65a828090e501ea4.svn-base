...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span>人力资源
    <span class="c-gray en">&gt;</span>组织架构管理
...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a class="btn btn-primary radius" onclick="department.add('0');" href="javascript:void(0);">
    ...
    <table id="dataTableList" class="table table-border table-bordered table-hover table-bg table-sort">
        <thead>
        <tr class="text-c">
            <th scope="col" colspan="9" align="center">组织架构管理</th>
        </tr>
        <tr class="text-c">
            <th>组织架构名称</th>
            <th width="200">操作</th>
...
<script type="text/javascript" src="<c:url value='/static/js/templates/manage/employee/department/department-index.js'/>" charset="utf-8"></script>
</body>
</html>