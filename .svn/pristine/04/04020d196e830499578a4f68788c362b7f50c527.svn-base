...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a class="btn btn-primary radius" onclick="menu.add(0);" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加</a>
        </span>
    </div>
    ...
    <table id="dataTableList" class="table table-border table-bordered table-hover table-bg table-sort">
        <thead>
        <tr class="text-c">
            <th scope="col" colspan="9" align="center">菜单管理</th>
        </tr>
        <tr class="text-c">
            <th>菜单名称</th>
            <th width="300">菜单链接地址</th>
            <th width="200">操作</th>
        </tr>
        </thead>
        <tbody></tbody>
...
<script type="text/javascript" src="<c:url value='/static/js/templates/manage/system/sys-menu/menu-index.js'/>" charset="utf-8"></script>
</body>
</html>