...
public class EmployeeExaminationQuestionServiceImpl implements EmployeeExaminationQuestionService {
    ...
    @Override
    public List<EmployeeExaminationQuestionItem> findItemByQuestionId(String questionId) {
        return employeeExaminationQuestionDao.findItemByQuestionId(questionId);
    }
}
