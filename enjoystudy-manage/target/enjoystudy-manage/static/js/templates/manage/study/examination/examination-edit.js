$("#inputForm").validate({
    ...
    submitHandler : function(form) {
        ...
        $.ajax({
            type: "post",
            url: ctx + "/manage/study/examination/save.jhtml",
            cache: false,
...
Examination.prototype = {
    view: function (id) {
        $.ajax({
            type: "post",
            url: ctx + "/manage/study/examination/view.jhtml",
            cache: false,
...
function initCourseList() {
    $.ajax({
        type: "post",
        url: ctx + "/manage/study/examination/course-list.jhtml?rnd=" + Math.random(),
        cache: false,
        dataType: "json",
        success: function (res) {
            if (res.status) {
