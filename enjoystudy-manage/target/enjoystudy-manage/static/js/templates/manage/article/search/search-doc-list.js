                ...
                if (res.status) {
                    ...
                    if (array.length > 0) {
                        for (var i = 0; i < array.length; i++) {
                            ...
                            html += "<tr>";
                            html += "<td colspan=\"2\"><p><a href=\"javascript:void(0);\" onclick=\"searchObj.view(" + data.id + ")\">" + title + "</a></p><p><a href=\"javascript:void(0);\" onclick=\"searchObj.view(" + data.id + ")\">" + highlight.content + "</a></p></td>";
                            html += "</tr>";
                        }
                    } else {
                        html += "<tr>";
