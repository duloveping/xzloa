...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span>考试题管理
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a class="btn btn-primary radius" onclick="examination.add();" href="javascript:void(0);"><i class="Hui-iconfont">&#xe600;</i> 添加</a>
        </span>
    </div>
    ...
    <table id="dataTableList" class="table table-border table-bordered table-hover table-bg table-sort">
        <thead>
        <tr class="text-c">
            <th scope="col" colspan="9" align="center">考试题管理</th>
        </tr>
        <tr class="text-c">
            <th width="200">课程</th>
            <th>标题</th>
...
<script type="text/javascript" src="<c:url value='/static/js/templates/manage/study/examination/examination-index.js'/>"></script>
</body>
</html>