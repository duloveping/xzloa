...
<div class="page-container">
    ...
    <table id="dataTableList" class="table table-border table-bordered table-hover table-bg table-sort">
        <thead>
        <tr class="text-c">
            <th scope="col" colspan="6" align="center">考卷管理</th>
        </tr>
        <tr class="text-c">
            <th>标题</th>
            <th width="100">操作</th>
...
<script type="text/javascript" src="<c:url value='/static/js/templates/manage/study/examination-paper/paper-index.js'/>"></script>
</body>
</html>