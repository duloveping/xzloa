    ...
    <form:form id="inputForm" modelAttribute="so" method="post" action="#" cssClass="form form-horizontal">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">
                <span class="c-red">*</span>所属课程分类：
            </label>
            <div class="formControls col-xs-8 col-sm-9">
                <form:input id="parentName" path="parentName" cssClass="input-text" onclick="showTypeSingleDialog($('#parentId').val())"/>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">
...
<script type="text/javascript" src="<c:url value='/static/js/templates/manage/study/course-type/type-edit.js' />"></script>
</body>
</html>