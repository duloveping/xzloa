function goPage(curr) {
    $.ajax({
        type: "post",
        url: ctx + "/manage/employee/account/list.jhtml",
        cache: false,
        data: {
            "pageNum": curr,
            "pageSize": 20,
...
Employee.prototype = {
    ...
    add: function () {
        var index = layer.open({
            ...
            area: ['640px', '480px'],
            maxmin: true,
            content: ctx + '/manage/employee/account/edit.jhtml?rnd=' + Math.random()
        });
        layer.full(index);
    },
    edit: function (id) {
        var index = layer.open({
            ...
            area: ['640px', '480px'],
            maxmin: true,
            content: ctx + '/manage/employee/account/edit.jhtml?id=' + id + '&rnd=' + Math.random()
        });
        layer.full(index);
    },
