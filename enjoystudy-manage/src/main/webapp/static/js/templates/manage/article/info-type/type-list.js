        ...
        success: function (res) {
            if (res.status) {
                ...
                for (var i = 0; i < array.length; i++) {
                    ...
                    if (del == 1) {
                        html += "<a href=\"javascript:void(0);\" onclick=\"infoType.delete(this, " + data.id + ");\">删除</a></td>"
                    }
                    html += "</tr>";
                }
...
InfoType.prototype = {
    ...
    add: function () {
        top.layer.open({
            ...
            area: ['640px', '480px'],
            maxmin: true,
            content: '../../manage/article/info-type/edit.jhtml?type.id=' + $("#typeId").val() + '&rnd=' + Math.random()
        });
    edit: function (id) {
    },
        top.layer.open({
            ...
            content: '../../manage/article/info-type/edit.jhtml?id=' + id + '&rnd=' + Math.random
    },
