    ...
    <form:form id="inputForm" modelAttribute="so" method="post" action="#" cssClass="form form-horizontal">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-10">
                <form:input id="title" path="title" placeholder="标题" maxlength="500" cssClass="required input-text"/>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">
                <span class="c-red">*</span>类别：
            </label>
            <div class="formControls col-xs-8 col-sm-10">
                <form:hidden id="typeId" path="typeId" />
                <form:input id="typeName" path="typeName" readonly="true" placeholder="类别" cssClass="required input-text" onclick="showTypeSingleDialog($('#typeId').val());"/>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">
            ...
            <div class="formControls col-xs-8 col-sm-10">
                <form:input id="author" path="author" placeholder="发布人" maxlength="500" cssClass="required input-text"/>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-10">
                <form:textarea id="introduction" path="introduction" rows="5" cols="80" maxlength="1000" cssClass="textarea valid" onKeyUp="$.Huitextarealength(this, 500);" placeholder="简介"></form:textarea>
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-10 col-xs-offset-4 col-sm-offset-2">
                ...
                <form:hidden id="publisherId" path="publisherId" />
                <form:hidden id="publisherName" path="publisherName" />
            </div>
        </div>
    </form:form>
</article>
<script type="text/javascript" src="<c:url value='/static/js/templates/manage/web/news/news-edit.js' />"></script>
</body>
</html>