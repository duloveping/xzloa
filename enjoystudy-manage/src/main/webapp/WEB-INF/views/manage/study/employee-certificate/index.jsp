...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span>我的电子证书
...
<script type="text/javascript" src="<c:url value='/static/js/templates/manage/study/employee-certificate/certificate-index.js'/>"></script>
</body>
</html>