    ...
    <tr>
        <td colspan="2" valign="top" style="border-bottom:1px dashed #c8c8c8;">
            <div style="width:100%; height:45px; line-height:45px; border-bottom:2px solid #eeeeee;">
                ...
                <div class="LmTitle"><span style="font-size:16px;">订单支付成功</span></div>
            </div>
            <table id="courseTable" border="0" cellpadding="3" cellspacing="0" class="KCDetailTable" style="margin-bottom:20px;">
                ...
                <c:if test="${order.payState eq 1}">
                    <tr>
                        <td class="KCListTableTdValue">
                            <span style="margin-left:20px;">支付时间：<fmt:formatDate value="${order.payTime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="KCListTableTdValue">
                    ...
                    <tr>
                        <td class="KCListTableTdValue">
                            <span style="margin-left:20px;">
                                <a href="/manage/main/index.jhtml">进入学习平台</a>
                            </span>
                        </td>
                    </tr>
                </c:if>
                <c:if test="${order.payState ne 1}">
                    <tr>
                        <td class="KCListTableTdValue">
                            <span style="margin-left:20px;">订单状态：待支付</span>
                        </td>
                    </tr>
                </c:if>
                </tbody>
